...
use crate::http::{HttpError, HttpMethod, HttpResponse, HttpTransportErrorKind};
...
fn error_kind(error: &HttpError) -> &'static str {
    match error {
        ...
        HttpError::Transport { kind, .. } => match kind {
            HttpTransportErrorKind::Connection => "connection",
            HttpTransportErrorKind::Timeout => "timeout",
            HttpTransportErrorKind::Tls => "tls",
            HttpTransportErrorKind::Protocol => "protocol",
            HttpTransportErrorKind::Other => "transport_other",
        },
