...
use crate::sqlx::{SqlxClient, SqlxError};
...
fn error_kind(error: &SqlxError) -> &'static str {
    match error {
        ...
        SqlxError::Transport(kind) => match kind {
            crate::sqlx::SqlxTransportErrorKind::Connection => "connection",
            crate::sqlx::SqlxTransportErrorKind::Timeout => "timeout",
            crate::sqlx::SqlxTransportErrorKind::Protocol => "protocol",
            crate::sqlx::SqlxTransportErrorKind::Server => "server",
            crate::sqlx::SqlxTransportErrorKind::Network => "network",
            crate::sqlx::SqlxTransportErrorKind::Decode => "decode",
            crate::sqlx::SqlxTransportErrorKind::Encode => "encode",
            crate::sqlx::SqlxTransportErrorKind::Tls => "tls",
            crate::sqlx::SqlxTransportErrorKind::Other => "transport_other",
        },
    }
}
